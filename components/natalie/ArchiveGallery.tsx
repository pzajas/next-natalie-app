...
/** Jednolita wysokość kafla na desktopie — siatka bez „schodków”. */
const tileClass =
  "relative min-h-[260px] w-full overflow-hidden shadow-subtle md:h-[300px] md:min-h-0";
    ...
    >
      <ContentContainer>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-12 md:gap-4">
          <div className={`group gallery-color-reveal-target ${tileClass} md:col-span-6`}>
          ...
          <div
            className={`flex items-center justify-center border border-black/12 bg-white p-6 shadow-subtle md:col-span-4 md:p-8 ${tileClass}`}
          >
            <p className="font-playfair text-center text-xl italic leading-relaxed text-black md:text-2xl">
              &quot;Dopieszczenie bez przepychu — schludnie, bez nadmiernej stylizacji. Włosy mają dobrze
              wyglądać od rana do wieczora.&quot;
            </p>
          </div>
          <div className={`group gallery-color-reveal-target ${tileClass} md:col-span-4`}>
            <GalleryPhotoZoomShell>
              <Image
          ...
          <div className={`group gallery-color-reveal-target ${tileClass} md:col-span-8`}>
            <GalleryPhotoZoomShell>
              <Image
